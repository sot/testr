...
def on_head_network():
    ...
    This looks for a list of subnets corresponding to linux machines listed
    in the HEAD `nodeinfo` database. Last updated on 2022-08-30. It also
    requires that the path /proj/sot/ska exists (because there are machines
    on those subnets that do not have /proj/sot/ska on their filesystem).
    """
    # Generated by utils/get_head_subnets.py
    head_subnets = set(
        [
            '9', '18', '40', '41', '42', '43', '45', '46', '47', '48', '51', '52', '56', '72',
            '105', '128', '152', '156', '157', '184', '185', '192', '197', '198', '232',
            '240', '246'
        ]
    )
    try:
        ...
        out = (ips[0] == '131' and
               ips[1] == '142' and
               ips[2] in head_subnets)
        out = out and Path('/proj', 'sot', 'ska').exists()
